    ...
    function dragstart(id, position, subject, move, end) {
      return function() {
        ...
        function ended() {
          ...
          var dx = p[0] - origin_[0], dy = p[1] - origin_[1];
          dispatch({
            type: "dragend",
            x: p[0] + offset[0],
            y: p[1] + offset[1],
    ...
    function axis(g) {
      ...
      if (g) {
        g.each(function() {
          ...
          }).style("opacity", 1e-6), tickExit = d3.transition(tick.exit()).style("opacity", 1e-6).remove(), tickUpdate = d3.transition(tick.order()).attr("class", function(d, i) {
            return d.subindex ? "tick minor" : "tick major";
