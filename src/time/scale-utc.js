...
var d3_time_scaleUTCFormats = [
  ...
  [d3.time.format.utc("%H"), function(d, a) { return a.getUTCHours() !== d.getUTCHours(); }],  // [abh] Make the "auto-scaling" time formats use 24-hour hours instead of 12-hours and AM/PM
